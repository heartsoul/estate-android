 ...
 * Leader:周瑞峰
 */
//public class TNBDateView2 extends View {
//
...
//	 * Constructor
//	 */
//	public TNBDateView2(Context context, AttributeSet attrs, int defStyle) {
...
//	 * Constructor
//	 */
//	public TNBDateView2(Context context, AttributeSet attrs) {
//		super(context, attrs);
//		initData(context);
//	}
//
...
//	 * Constructor
//	 */
//	public TNBDateView2(Context context) {
//		super(context);
//		initData(context);
//	}
//
...
//		Bitmap bm = Bitmap.createBitmap(100, 50, Config.RGB_565);
//		Canvas cs = new Canvas(bm);
//		cs.drawColor(Color.parseColor("#C7C7C7"));
//		centerDrawable = new BitmapDrawable(getResources(), bm);
//	}
//
//	/**
//	 * Invalidates wheel
