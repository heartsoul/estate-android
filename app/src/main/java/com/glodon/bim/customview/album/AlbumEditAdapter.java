...
public class AlbumEditAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewholder, int position) {
        ...
        if(mSelectedMap.containsKey(item.imagePath)){
            holder.mSelectView.setBackgroundResource(R.drawable.icon_album_selected);
        }else{
            holder.mSelectView.setBackgroundResource(R.drawable.icon_album_normal);
        }
        //设置点击
