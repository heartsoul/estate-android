...
public interface UploadImageApi {
    ...
    Call<ResponseBody> getOperationCode(@Query("containerId") String containerId, @Query("inspectItem") String name, @Query("digest") String digest, @Query("length") long length, @Header("cookie") String cookie);
