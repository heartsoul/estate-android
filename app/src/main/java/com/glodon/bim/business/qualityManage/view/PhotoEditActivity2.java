 ...
 */
public class PhotoEditActivity2 extends BaseActivity {
...
//    private ImageView iv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.quality_photo_edit_activity_);
...
//                ImageLoader.showImage(PhotoEditActivity.this,mSavePath,mShow);
                ImageLoader.loadUrl(PhotoEditActivity2.this, mSavePath, new OnImageLoadListener() {
                    @Override
                    public void onLoadBitmap(Bitmap bitmap) {
