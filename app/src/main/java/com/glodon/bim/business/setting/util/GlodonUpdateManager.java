...
public class GlodonUpdateManager {
    ...
    class UpdateDialog {
        ...
        private void show() {
            ...
            android.view.WindowManager.LayoutParams layoutParams = dialogWindow
                    .getAttributes();
    ...
    class ForceUpdateDialog {
        ...
        public void showUpdateView() {
            updateIcon.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_update_notice));
        ...
        public void showLoadingView() {
            updateIcon.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_update_progress));
        ...
        public void showFinishView() {
            updateIcon.setImageDrawable(context.getResources().getDrawable(R.drawable.icon_update_success));
