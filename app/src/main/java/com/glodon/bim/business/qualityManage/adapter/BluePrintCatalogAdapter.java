...
public class BluePrintCatalogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Activity mActivity;
    private List<BlueprintListBeanItem> mDataList;
//    private ImageView mLastView;
//    private TextView mLastTextView;
    private OnBlueprintCatalogClickListener mListener;
    private int mLastPosition = -1;

    public BluePrintCatalogAdapter(Activity mActivity) {
        this.mActivity = mActivity;
        mDataList = new ArrayList<>();
    }

    public void updateList(List<BlueprintListBeanItem> dataList){
        mDataList=dataList;
...
//        }
    ...
    public void setListener(OnBlueprintCatalogClickListener onModuleCatalogClickListener) {
