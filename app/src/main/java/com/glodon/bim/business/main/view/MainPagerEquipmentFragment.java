...
import com.glodon.bim.business.main.presenter.MainPagerEquipmentPresenter;
...
public class MainPagerEquipmentFragment extends BaseFragment implements MainPagerEquipmentContract.View{

    private RecyclerView mRecyclerView;
    private MainPagerQualityEquipmentAdapter mAdapter;
    private MainPagerEquipmentContract.Presenter mPresenter;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflate(R.layout.quality_main_fragment_main_page_equipment);
        initView(view);
        setListener();
        initData();
        return view;
    ...
    private void initView(View view) {
        mRecyclerView = view.findViewById(R.id.main_pager_equipment_recyclerview);
    ...
    private void initData() {
        mPresenter = new MainPagerEquipmentPresenter(this);
