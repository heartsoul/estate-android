...
public interface CreateReviewApi {
    ...
    Observable<SaveBean> editSaveRepair(@Path("deptId") long deptId,@Path("id") long id, @Body QualityRepairParams props,@Header("cookie") String cookie);
    ...
    Observable<SaveBean> editSubmitRepair(@Path("deptId") long deptId,@Path("id") long id, @Body QualityRepairParams props,@Header("cookie") String cookie);
    ...
    Observable<SaveBean> editSaveReview(@Path("deptId") long deptId,@Path("id") long id, @Body QualityReviewParams props, @Header("cookie") String cookie);
    ...
    Observable<SaveBean> editSubmitReview(@Path("deptId") long deptId,@Path("id") long id, @Body QualityReviewParams props, @Header("cookie") String cookie);
